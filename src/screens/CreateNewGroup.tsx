...
import { getUser } from '../database/userFirebase';
  ...
  return (
    <View style={styles().container}>
      ...
      <View style={styles().buttonsContainer}>
          <PrimaryButton loading={loading}text={'Next'}accion={CrearGrupo} disabled={!inputWrite || activeBtn==''} customStyles={{marginTop:80}} />
        </View>
